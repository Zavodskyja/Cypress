...
export class ArtistPage {
    ...
    {
        // 16= P
        cy.get('.chr-scrolling-carousel > div.chr-scrolling-carousel__content > li:nth-child(16) > chr-button > a').click()
    }
    ...
    artistClick(){
        ...
        .should('exist').click();
        cy.wait(10000);
        cy.url().should('eq',`${Cypress.env('productUrl')}/en/artists/pablo-picasso`)
